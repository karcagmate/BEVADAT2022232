...
class KNNClassifier:
    ...
    def train_test_split(self,featrues:np.ndarray,labels:np.ndarray):
        ...
        x_test,y_test=featrues[train_size:train_size+test_size,:],labels[train_size:train_size+test_size]
    ...
    def perdict(self,x_test:np.ndarray):
        labels_pred=[]
